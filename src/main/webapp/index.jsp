...
var MOVIES = [
  ...
  { id:2, title:'Bethlehem Kudumba Unit', genre:'Action / Epic', lang:'Telugu', rating:9.0, votes:'210K',
    cert:'UA', duration:'3h 00m', img:'https://assets-in.bmscdn.com/iedb/movies/images/mobile/thumbnail/xlarge/bethlehem-kudumba-unit-et00502829-1788413826.jpg', badge:'New',
    cities:['hyd','vzg','vjw','gnt','tpt','wgl'] },
  { id:3, title:'Epic', genre:'Sci-Fi / Mythological', lang:'Telugu', rating:9.5, votes:'340K',
    cert:'UA', duration:'2h 55m', img:'https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC,e-usm-2-2-0.5-0.008:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-image,i-discovery-catalog@@icons@@star-icon-202203010609.png,lx-24,ly-615,w-29,l-end:l-text,ie-OC4zLzEwICA1SysgVm90ZXM%3D,fs-29,co-FFFFFF,ly-612,lx-70,pa-8_0_0_0,l-end/et00515338-hfermmaflw-portrait.jpg',
